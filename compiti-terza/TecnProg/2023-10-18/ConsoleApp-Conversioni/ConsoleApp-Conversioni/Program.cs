    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                if (tempNumber % 16 >= 10)
                {
                    numberBase16 = (char)((tempNumber % 16) - 10 + 'A') + numberBase16; // se è maggiore di 10 prendo A, B, C, D, E o F
                }
                else
                {
                    numberBase16 = $"{tempNumber % 16}" + numberBase16; // altrimenti metto il numero come stringa
                }
