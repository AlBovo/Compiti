/**********************************
* Alan Davide Bovo 3H 2023-10-31 *
*        Conversione Di Base     *
*********************************/
    ...
    internal class Program
    {
        ...
        static int BaseToInt(string input, int baseInput)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                risultato += pos * (int)Math.Pow(baseInput, length - i - 1); // calcolo la conversione
            }
            #endregion
        ...
        {
            int resto; // variabile per calcolare il resto della divisione
            string valore = ""; // variabile per il valore convertito
            ...
            while (input > 0)
            {
                resto = input % baseInput; // calcolo del resto
                input /= baseInput; // divisioni successive
                valore = ALPHABET[resto] + valore; // calcolo del valore nella nuova base
            }
            #endregion
        ...
        {
            Console.Title = "Alan Davide Bovo 3H 2023-10-31";
            Console.WriteLine("Alan Davide Bovo 3H 2023-10-31");
            char choice;
            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case 'b':
                        ...
                        Console.WriteLine($"Il valore convertito a base {baseInput} è {IntToBase(value, baseInput)}"); // stampa del risultato
                        break;
                    #endregion
                    ...
                    case 'i':
                        ...
                        Console.WriteLine($"La stringa in base {baseInput} convertita ad intero equivale a {BaseToInt(valueString, baseInput)}"); // stampa del risultato
                        break;
                    #endregion
