...
namespace CorsaConTreni
{
    internal class Program
    {
        ...
        #region Classe Treno
        /// <summary>
        /// Classe per gestire il movimento autonomo dei treni
        /// </summary>
        class Treno
        {
            ...
            /// </summary>
            /// <param name="n">Identificativo del treno</param>
            public Treno(int n)
            {
            ...
            /// <summary>
            /// Metodo per stampare il treno e aggiornarlo con un'animazione
            /// </summary>
        ...
        /// <summary>
        /// Classe per gestire il movimento autonomo del corridore 
        /// </summary>
        class Persona
        {
            ...
            /// </summary>
            /// <param name="pos">Posizione iniziale della persona</param>
            ...
            /// <summary>
            /// Metodo per eseguire un comando sulla persona
            /// </summary>
            public void Comando()
            {
                ...
                switch (scelta)
                {
                    case 'S': // sospendere il thread scelto
                        lock (_lock)
                            if (_persona.IsAlive)
                                _persona.Suspend();
                        break;

                    case 'R': // riprendere il thread scelto
                        if (_persona.ThreadState == ThreadState.Suspended)
                            _persona.Resume();
                        break;

                    case 'A': // eseguire l'abort del thread scelto
                        lock (_lock)
                            try
                            {
                                if (_persona.ThreadState == ThreadState.Suspended)
                            ...
                            catch { Thread.CurrentThread.Abort(); } // abort del thread principale se non funziona
                        break;
                }
            }
            #endregion
        ...
        /// <summary>
        /// Metodo per la stampa iniziale della ferrovia
        /// </summary>
        static private void StampaFerrovia()
        {
            ...
            WriteLine("                             |" + new string(' ', 5) + "|                             |" + new string(' ', 5) + "|");
            WriteLine("Stato Mario                  |" + new string(' ', 5) + "|                             |" + new string(' ', 5) + "|");
            WriteLine("Is alive =                   |" + new string(' ', 5) + "|                             |" + new string(' ', 5) + "|");
        ...
        /// <summary>
        /// Metodo per aggiornare a console lo stato dei treni
        /// </summary>
        static void AggiornaStato()
        {
            bool treno0, treno1, persona; // variabili per gestire lo stato dei treni
            do
            {
        ...
        /// <summary>
        /// Main per inizializzare i treni e avviare la corsa
        /// </summary>
        ...
        static void Main(string[] args)
        {
            ...
            _persona = new Thread(mario.Muovi); // instanzio il thread per l'animazione di mario
            _persona.Start(); // mario inizia a camminare
            ...
            while (_persona.IsAlive) // finche' mario e' vivo
                if (KeyAvailable) mario.Comando();
