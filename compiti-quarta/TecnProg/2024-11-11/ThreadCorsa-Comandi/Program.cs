...
namespace ThreadCorsa
{
    internal class Program
    {
        ...
        static void Menu(string titolo)
        {
            ...
            Scrivi(0, 17, "Andrea (A)".PadRight(20));
            Scrivi(0, 18, "Baldo  (B)".PadRight(20));
            Scrivi(0, 19, "Carlo  (C)".PadRight(20));
        }
        ...
        static char MenuAzioni(string titolo)
        {
            ...
            //Scrivi(0, 20, "Aspettare  (J)".PadRight(10));
        ...
        static void Comando()
        {
            char scelta = ReadKey(true).KeyChar;
            Thread thread;

            switch (char.ToUpper(scelta))
            {
                case 'A':
                    thread = threads[0];
                    break;
            ...
            scelta = MenuAzioni("AZIONE DA ESEGUIRE SU: " + thread.Name);
