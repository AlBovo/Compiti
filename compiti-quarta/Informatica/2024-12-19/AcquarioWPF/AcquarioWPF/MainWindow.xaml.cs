...
namespace AcquarioWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private AnimatoSulFondo PesceAnimato()
        {
            ...
            return new(uri, (1, 150), 5, canvasAcquario);
        }

        private AnimatoSulPosto PescePosto()
        {
            Uri uri = new("immagini/alga.png", UriKind.RelativeOrAbsolute);
            return new(uri, (100, 350), 0, canvasAcquario);
        }

        private AnimatoSilurante PescePilotato()
        {
            Uri uri = new("immagini/pesce.png", UriKind.RelativeOrAbsolute);
            return new(uri, (100, 200), 5, canvasAcquario);
        }
        ...
        public MainWindow()
        {
            ...
            pesciFondo.Start();
            pescePilotato.Tick += new EventHandler(pesce3.MuoviSiluri);
            pescePilotato.Interval = TimeSpan.FromMilliseconds(30);
            pescePilotato.Start();
